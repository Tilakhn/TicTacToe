...
public class MainActivity extends AppCompatActivity {
    ...
    public void restartMatch(){
        ...
        image1.setImageResource(R.drawable.white_back);
        image2.setImageResource(R.drawable.white_back);
        image3.setImageResource(R.drawable.white_back);
        image4.setImageResource(R.drawable.white_back);
        image5.setImageResource(R.drawable.white_back);
        image6.setImageResource(R.drawable.white_back);
        image7.setImageResource(R.drawable.white_back);
        image8.setImageResource(R.drawable.white_back);
        image9.setImageResource(R.drawable.white_back);
